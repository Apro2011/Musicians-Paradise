...
class Musician(models.Model):
    ...
    music_1 = models.FileField(upload_to="music", default=None, blank=True)
    ...
    music_2 = models.FileField(upload_to="music", default=None, blank=True)
    ...
    music_3 = models.FileField(upload_to="music", default=None, blank=True)
